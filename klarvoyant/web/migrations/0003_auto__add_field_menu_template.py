...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'web_menu', 'template',
                      self.gf('django.db.models.fields.CharField')(default='name of the template', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Menu.template'
        db.delete_column(u'web_menu', 'template')
